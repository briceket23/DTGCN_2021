...
source_path = r'D:\Research downloads\datasets\dataset brice\DTGCN_DATA\2_Large_scale_Malaria_Parasite_Recognition\train'
target_path = r'D:\Research downloads\datasets\dataset brice\DTGCN_DATA\2_Large_scale_Malaria_Parasite_Recognition\test'
